package com.sc.l45.weblogviewer.test.arquillian;
...
public class ApiTest extends ApiTestConf {
    ...
    @Test
    @RunAsClient
    public void getFileData(@ArquillianResource URL baseUrl) throws URISyntaxException, MalformedURLException {
    	final String filePath = testFile.getAbsolutePath();
	...
	@Test
    @RunAsClient
    public void getHomeDir(@ArquillianResource URL baseUrl) throws URISyntaxException, MalformedURLException {
